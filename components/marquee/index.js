...
Component({
    ...
    methods: {
        ...
        _init: function() {
            var t = this;
            wx.createSelectorQuery().in(this).select(".geek-noticebar__content").boundingClientRect(function(e) {
                if (!e || !e.width) throw new Error("页面缺少 noticebar 元素");
                t.setData({
                    width: e.width
                }), wx.createSelectorQuery().in(t).select(".geek-noticebar__content-wrap").boundingClientRect(function(e) {
                    if (e && e.width) {
